    ...
    <aside style={{
      ...
      <div>
        ...
        <div style={{ display:"flex", alignItems:"center", gap:10, marginBottom:36, paddingLeft:4 }}>
          ...
          {/* Brand name */}
          <span style={{ fontSize: 18, fontWeight: 800, color: "#1A1A1A", letterSpacing: -0.3 }}>BILLBITE</span>
          {/* Collapse chevron */}
          <button style={{ marginLeft:"auto", background:"none", border:"none", cursor:"pointer", color:"#9CA3AF", display:"flex", alignItems:"center", padding:4 }}>
            <Icons.ChevronLeft />
          </button>
        </div>
